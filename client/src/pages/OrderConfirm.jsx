        ...
        <div className="flex items-center justify-center min-h-screen bg-white">
          ...
          <div className="p-8 bg-gray-100 rounded-lg shadow-lg text-center">
            ...
            <p className="text-lg text-gray-700 mb-4">
              Cảm ơn bạn đã mua hàng của E-Computer!
            </p>
            <div className="bg-white p-4 rounded shadow-sm mb-4">
              ...
              {order && (
                <div className="text-left">
                  <p>
                    <strong> ID giao dịch:</strong> {order._id}
                  </p>
                  <p>
                    <strong>Tên người thanh toán:</strong> {order.user.name}{" "}
                  </p>
                  <p>
                    <strong>Email người thanh toán:</strong> {order.user.email}
                  </p>

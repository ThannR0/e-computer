                ...
                <div className="gap-4 sm:flex sm:items-center sm:justify-between">
                  ...
                  <div className="mt-6 gap-4 space-y-4 sm:mt-0 sm:flex sm:items-center sm:justify-end sm:space-y-0">
                    <div>
                      ...
                      >
                        <option selected>Tất cả giao dịch</option>
                        <option value="pre-order">Order trước</option>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="last 3 months">3 tháng trước</option>
                        <option value="lats 6 months">6 tháng trước</option>
